  ...
  __forceinline void evalBishopsOneSide(const Side us) {
    ...
    for (BB bishops = game_.board.bishops(us); bishops; resetLSB(bishops)) {
      ...
      bishop_attacks[us] |= attacks;
			...
			if (bishop_trapped_a7h7[us] & bbSquare(sq)) {
				int x = file(sq)/7;
...
int Eval::pawn_isolated_open_mg = -50;
int Eval::pawn_isolated_mg = -20;
int Eval::pawn_isolated_eg = -25;
int Eval::rook_on_open = 20;
int Eval::rook_on_half_open = 5;

int Eval::bishop_pcsq_eg[64] = {
    0,  -35,    0,   20,  -10,  -30,    0,   30,
  -15,   10,    5,   20,  -35,    5,   15,   15,
  -15,    5,    0,  -20,   -5,   15,   10,    0,
  -10,    5,  -10,   15,  -10,   10,    0,    5,
  -15,   -5,    0,    5,    0,  -10,    0,  -25,
  -40,    5,   -5,    0,    0,    0,  -25,  -15,
  -10,  -30,  -15,  -15,  -20,  -40,  -25,  -50,
  -35,  -10,  -30,  -25,  -25,  -35,  -30,  -55 };

int Eval::bishop_pcsq_mg[64] = {
  -15,  -50,   10,  -20,    0,  -25,   75,    0,
  -35,  -25,   15,  -45,   40,    5,   -5,   10,
  -25,  -50,    5,  -10,   10,   45,   20,  -15,
  -20,    0,   -5,   20,   40,   15,    0,   10,
  -35,   -5,   -5,   10,   20,  -10,  -15,   -5,
  -20,    5,    5,   -5,  -10,  -10,  -10,  -15,
  -15,   10,  -10,  -15,  -15,  -15,   20,  -30,
  -35,  -10,  -30,  -30,  -25,  -20,  -30,  -15 };

int Eval::knight_pcsq_eg[64] = {
  -55,  -40,  -45,    0,    0,   -5,    0,  -95,
  -40,   45,  -10,   10,   25,   15,  -25,  -30,
  -25,    5,   15,   15,   20,   20,   15,  -15,
   10,   15,   15,   25,   30,   25,   15,   35,
  -15,   15,   20,   15,   20,   15,  -10,   10,
  -25,  -15,   -5,    0,   20,  -15,   -5,  -20,
  -35,  -30,  -15,  -20,  -10,  -25,  -10,  -40,
  -85,  -30,  -50,  -35,  -45,  -25,  -50, -105 };

int Eval::knight_pcsq_mg[64] = {
  -65, -110,  -95,    5,   65,  -65,   85, -105,
  -70,  -50,    0,   60,   45,   30,  -20,  -40,
  -40,   15,   10,   30,   50,   45,   30,   25,
    5,   10,   35,   45,   30,   30,   15,  -10,
  -15,  -10,    5,   20,   20,   25,    0,    5,
  -35,  -15,   -5,    5,   15,   10,    0,  -35,
  -35,  -40,  -20,    0,    0,  -15,  -15,  -40,
  -35,  -40,  -65,  -35,  -35,  -15,  -40, -150 };

int Eval::rook_pcsq_eg[64] = {
   45,   30,   20,   40,   25,   40,   25,   35,
   35,   15,   20,   30,   10,   15,   15,   20,
   20,   30,   35,   20,   30,   30,   35,   20,
   25,   35,   20,   25,   20,   25,   10,   15,
   -5,    5,    0,   -5,    5,    5,    5,    0,
  -20,  -15,  -15,  -10,  -10,   -5,  -25,  -15,
  -20,  -20,   -5,  -15,  -10,   -5,  -25,  -25,
   -5,  -10,   -5,  -10,    0,   -5,   -5,   -5 };

int Eval::rook_pcsq_mg[64] = {
  -35,   25,   40,   45,   25,   20,   30,   70,
  -30,    5,   15,   25,   40,   15,    0,   45,
   15,   30,   20,   30,   60,   75,   25,   30,
   -5,  -10,   15,    0,   20,   35,    0,   15,
  -25,    0,  -15,    5,    5,   15,  -20,    5,
  -35,  -30,  -15,  -10,   -5,  -10,  -10,  -20,
  -30,  -15,   -5,   -5,   -5,   -5,  -10,  -30,
  -10,   -5,    0,    0,    5,    5,    0,    0 };

int Eval::queen_pcsq_eg[64] = {
   20,   30,   25,   45,   45,   30,   60,   10,
   -5,   -5,   40,   50,   35,   50,   45,   30,
   -5,   15,   35,   35,   55,   55,   60,    0,
   20,   45,   35,   30,   45,   25,   30,   10,
  -10,   -5,    5,   15,    5,   10,   15,   30,
  -15,  -15,    5,  -15,    0,  -10,    0,  -15,
  -20,  -30,  -10,  -20,  -10,  -25,  -25,  -25,
  -15,  -30,  -25,  -15,  -25,  -20,  -30,  -40 };

int Eval::queen_pcsq_mg[64] = {
  -10,  -20,   10,   35,   50,   70,   70,   45,
  -15,  -35,  -25,  -20,   25,   45,    5,   40,
  -10,    0,   15,   20,   50,   50,   70,    5,
    0,  -35,    5,    5,   20,   35,   25,    5,
  -10,  -15,    5,    0,   10,   20,   15,  -20,
  -15,   -5,    5,    0,    5,    5,    0,    0,
  -15,  -10,   -5,    5,    5,    5,  -20,  -30,
  -15,  -20,  -15,    0,  -10,  -15,  -40,  -40 };
...
int Eval::passed_pawn_eg[8] = { 0, 30, -5, 25, 55, 115, 185, 0 };
int Eval::passed_pawn_mg[8] = { 0, -25, -15, -10, 50, 130, 200, 0 };
...
int Eval::pawn_pcsq_eg[64] = {
   0,   0,   0,   0,   0,   0,   0,   0,
   75,   85,   50,   30,   50,   50,   50,   70,
   45,   30,   35,   15,    0,   50,   45,   35,
   20,   20,    0,    0,    5,    0,    0,   15,
    5,   10,    5,    0,    0,   15,    0,    0,
    0,   -5,    5,   10,    5,   15,    0,    0,
    0,    0,   -5,   -5,   20,   15,   10,  -10,
...
int Eval::pawn_pcsq_mg[64] = {
   0,   0,   0,   0,   0,   0,   0,   0,
  70,   60,   20,   30,   30,   20,   10,   40,
  10,  -10,   10,   40,   30,   30,   30,   30,
  -5,    5,   10,   20,   25,   -5,  -15,  -10,
  -5,    0,   10,   10,   10,    0,  -10,  -10,
   0,   -5,    0,    0,   -5,   -5,   -5,    0,
   0,    5,   -5,  -10,  -10,   10,   15,   -5,
   0,    0,    0,    0,    0,    0,    0,    0 };
