...
BB bb_file_array[64];
BB bb_between[64][64];
BB passed_pawn_front_spans[2][64];
...
void Bitboard_h_initialise() {
	...
	for (Square sq = a1; sq <= h8; sq++) {
		...
		passed_pawn_front_spans[0][sq] = pawn_east_attack_span[0][sq] | pawn_front_span[0][sq] | pawn_west_attack_span[0][sq];
		passed_pawn_front_spans[1][sq] = pawn_east_attack_span[1][sq] | pawn_front_span[1][sq] | pawn_west_attack_span[1][sq];
...
const BB RankThree[2] = { RANK3, RANK6 };
const BB RankSeven[2] = { RANK7, RANK2 };
const BB RankSixAndSeven[2] = { RANK6|RANK7, RANK2|RANK3 };
const BB RankSevenAndEight[2] = { RANK7|RANK8, RANK1|RANK2 };

const int PawnPushDist[2] = { 8, -8 };
const int PawnDoublePushDist[2] = { 16, -16 };
const int PawnWestAttackDist[2] = { 9, -7 };
const int PawnEastAttackDist[2] = { 7, -9 };
